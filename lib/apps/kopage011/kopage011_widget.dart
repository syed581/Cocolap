...
import 'kopage011_model.dart';
export 'kopage011_model.dart';

class Kopage011Widget extends StatefulWidget {
  const Kopage011Widget({super.key});

  @override
  _Kopage011WidgetState createState() => _Kopage011WidgetState();
}

class _Kopage011WidgetState extends State<Kopage011Widget> {
  late Kopage011Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Kopage011Model());
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    _model.soundPlayer1!.setVolume(2.0);
                                    _model.soundPlayer1!
                                        .setAsset(
