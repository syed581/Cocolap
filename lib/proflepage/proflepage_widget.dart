...
import 'proflepage_model.dart';
export 'proflepage_model.dart';

class ProflepageWidget extends StatefulWidget {
  const ProflepageWidget({super.key});

  @override
  _ProflepageWidgetState createState() => _ProflepageWidgetState();
}

class _ProflepageWidgetState extends State<ProflepageWidget> {
  late ProflepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProflepageModel());
